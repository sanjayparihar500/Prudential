#The framework is developed in Protractor and Jasmine framework with Javascript(ECMA6),hence in order to run the test you need to install all requred libraries.
##Steps to follow:
